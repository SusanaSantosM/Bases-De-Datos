/*
Desenvolver una funcion llamada fcontaxogadoresp1 tal que pasandole el codigo de un equipo 
que devuelve el numero de jugadores que tiene.
*/
create or replace function fcontaxogadoresp1(c varchar) returns varchar language plpgsql as $$
...
conta int
begin
if count(*) into conta from equipo where nomeq=c;
else
